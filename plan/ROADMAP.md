...
### M03 — Settings + sidebar restructure  `[planned]`
Collapsible left rail with User and Org Settings sections. Adds VCS plugin picker (one per org), coding-agent picker (many per org), session-timeout override, verified GitHub-handle field for SSO users. → [details](milestones/M03-settings/README.md)
