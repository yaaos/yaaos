...
# yaaos-review-architecture (Wave 2 reviewer)

Wave 2 architecture reviewer. Apply the `yaaos-architecture-review` skill to the diff and emit findings.
...
1. Read the Wave 1 files to ground claims about boundaries and conventions; do not redo their work.
...
3. Apply the `yaaos-architecture-review` skill end-to-end against the diff.
