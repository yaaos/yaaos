...
- `web.py`, `user_web.py`, `org_settings_web.py`, `sso_web.py`, `audit_web.py`, `coding_agents_web.py`, `vcs_web.py`, `api_keys_routes.py` are **side-effect-only** route-registration modules — never imported for their symbols.
