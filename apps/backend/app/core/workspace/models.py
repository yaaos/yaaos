...
class WorkspaceRow(Base):
    ...
    # M05: discriminator the engine uses to pick a dispatch path. `in_memory`
    ...
    # M05 single-flight claim: only one in-flight AgentCommand per workspace.
    ...
    # M05: which workflow execution currently holds the workspace. Soft FK to
    ...
    # M05: idle-timeout sweep horizon. The reaper marks any workspace
